...
idea_frm_tenders_df = pd.read_csv(os.getcwd()+'/Assam_MCH_analysis/TENDERS/data/mch_tenders_all.csv')

#ASSAM_VILLAGES = gpd.read_file(os.getcwd()+'/Maps/assam_village_complete_with_revenueCircle_district_35_oct2022.geojson',
 #                              driver='GeoJSON')
ASSAM_VILLAGES = pd.read_csv(os.getcwd()+r'/Assam_MCH_analysis/TENDERS/maps/ASSAM_VILLAGES_RC_DISTRICT_MAPPING.csv', encoding='utf-8').dropna()
...
idea_frm_tenders_df.to_csv(os.getcwd()+'/Assam_MCH_analysis/TENDERS/data/mchtenders_districtgeotagged.csv',index=False)
